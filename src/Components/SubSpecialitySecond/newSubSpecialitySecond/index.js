...
import useNewSubSpecialitySecond from './useNewSubSpecialitySecond';
import Select from 'react-select';

const NewSubSpecialitySecond = () => {
	const { onSubmit, register, handleSubmit, errors, formState, setSpeciality, error, loading, api } = useNewSubSpecialitySecond();
...
export default NewSubSpecialitySecond;
