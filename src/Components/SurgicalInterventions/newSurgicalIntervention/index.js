...
import useNewSurgicalIntervention from './useNewSurgicalIntervention';

const NewSurgicalIntervention = () => {
	const { onSubmit, register, handleSubmit, errors, formState, setModule } = useNewSurgicalIntervention();
...
export default NewSurgicalIntervention;
